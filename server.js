  ...
  try{
    const r=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(model)}:generateContent`,{
      ...
      body:JSON.stringify({
        ...
        generationConfig:{temperature:mode==='summary'?0.3:0.2,topP:0.8,maxOutputTokens:mode==='summary'?700:1100}
      })
    });
...
http.createServer((req,res)=>{
  ...
  if(req.method==='GET'&&url.pathname==='/')return send(res,200,{success:true,service:'MUST ISP AI Cloud Run',version:'1.0.6',region:'asia-east1',route:'POST /ai/isp-summary',models:MODELS,outputCompletenessCheck:true},origin);
